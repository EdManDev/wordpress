...
class mtsGoogleTypography {
	...
	function options_ui() {
		...
		$collection_title 			= __('New Collection', 'mythemeshop' );
        ...
        $backup_font_title          = __('Fallback:', 'mythemeshop' );
		$css_selectors_title	= __('CSS Selectors:', 'mythemeshop' );
...
EOT;
	...
	function admin_scripts() {
		...
		wp_localize_script('google-typography', 'googletypography', array(
	            'reset_confirm' => __("Are you sure you want to revert to the theme's default collections? Note: You will lose any custom collections you've created.", 'mythemeshop' ),
