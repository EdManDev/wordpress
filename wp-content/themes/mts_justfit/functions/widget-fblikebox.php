...
class Facebook_Like_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
			<div class="fb-page" data-href="<?php echo esc_attr( $page_url ); ?>" data-width="<?php echo esc_attr( $width ); ?>" data-hide-cover="<?php echo esc_attr( $hide_cover ); ?>" data-show-facepile="<?php echo esc_attr( $show_faces ); ?>" data-show-posts="<?php echo esc_attr( $show_stream ); ?>"></div>
		<?php endif;
	...
	{
		$defaults = array('title' => __('Find us on Facebook', 'mythemeshop' ), 'page_url' => '', 'width' => '360', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => 'on');
		...
		<p>
			...
			<input type="text" class="widefat" style="width: 216px;" id="<?php echo $this->get_field_id('page_url'); ?>" name="<?php echo $this->get_field_name('page_url'); ?>" value="<?php echo esc_attr( $instance['page_url'] ); ?>" />
		</p>
