...
echo '<span class="headtext">Welcome to your theme\'s mission control center.</span>';
					...
					if ( ! MTS_THEME_WHITE_LABEL ) {
						echo '<a href="http://community.mythemeshop.com/" class="docsupport" target="_blank"><i class="fa fa-medkit"></i> '.__('Support', 'mythemeshop').'</a>';
					}
				...
				echo '<div id="nhp-opts-sidebar">';
					echo '<ul id="nhp-opts-group-menu">';
						...
						echo '<div id="options-search-no-results">'.__('No options found, please refine your query.', 'mythemeshop' ).'</div><!--search: no results-->';
